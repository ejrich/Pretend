...
void main()
{
    ...
    if (textureIndex >= 0) {
        ...
        //if (textureIndex >= 1) outputColor = vec4(0, 0, 1, 1);
        //if (textureIndex >= 2.0) outputColor = vec4(0, 1, 0, 1);
        //if (textureIndex >= 3.0) outputColor = vec4(1, 0, 0, 1);
        //outputColor *= texture(texture0, texCoord);
        //switch (textureIndex) {
        ...
        //    case 4: outputColor = vec4(0, 0, 0, 1); break;//outputColor *= texture(textures[4], texCoord); break;
